      ...
      <h1 className='text-sky-600 font-black text-6xl capitalize'> Recupera tu acceso y no pierdas tus {''}
        ...
        <form action="" className='my-10 bg-white shadow rounded-lg p-10 ' onSubmit={handleSubmit}>
            <div className='my-5'>
                ...
                <input type="email" name="" id="email" placeholder='Registra tu email' className='w-full mt-3 p-3 border rounded-xl bg-gray-50 ' 
                    value={email} onChange={ e => setEmail(e.target.value)}
                />
            </div>
            
            
            <input type="submit" value="Enviar instrucciones" className='bg-sky-700 mb-5 w-full py-3 text-white uppercase| font-bold rounded
