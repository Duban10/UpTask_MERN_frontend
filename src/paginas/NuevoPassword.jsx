        ...
        { tokenValido && (
            <form action="" className='my-10 bg-white shadow rounded-lg p-10 ' onSubmit={handleSubmit}>
                ...
                <div className='my-5'>
                    ...
                    <input type="password" name="" id="password" placeholder='Escribe tu nuevo password' className='w-full mt-3 p-3 border rounded-xl bg-gray-50 ' 
                        value={password}
                        onChange={e => setPassword(e.target.value)}
                    />
                </div>
                
                <input type="submit" value="  Guardar nuevo password" className='bg-sky-700 mb-5 w-full py-3 text-white uppercase| font-bold rounded
