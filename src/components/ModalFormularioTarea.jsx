...
const ModalFormularioTarea = () => {
    ...
    const { modalFormularioTarea, hanledModalTarea, mostrarAlerta, alerta, submitTarea, tarea } = useProyectos()
    ...
    return (
        ...
        <Transition.Root show={ modalFormularioTarea } as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={ hanledModalTarea }>
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <form action="" className='my-10' onSubmit={hanledSubmit}>
                                        <div className="mb-5">
                                            ...
                                            <input type="text" className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md ' 
                                                id='nombre' placeholder='Nombre de la tarea' value={nombre} onChange={e => setNombre(e.target.value)}                                                    
                                            />
                                        </div>
                                        <div className="mb-5">
                                        ...
                                        <div className="mb-5">
                                            ...
                                            <input type="date" className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md ' 
                                                id='fecha-entrega' value={fechaEntrega} onChange={e => setFechaEntrega(e.target.value)}                                                    
                                            />
                                        </div>
                                        <div className="mb-5">
                                            ...
                                            <select className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md ' 
                                                id='prioridad' value={prioridad} onChange={e => setPrioridad(e.target.value)}                                                    
                                            >
